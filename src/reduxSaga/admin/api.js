...
import { BASE_URL, DELETE_ELECTION, DELETE_PARTY, DELETE_VOTER, GET_ELECTION, GET_PARTY, GET_VOTER, POST_ELECTION, POST_PARTY, POST_VOTER } from "../constant";
...
export { get_party, post_party, delete_party, get_voter, post_voter, delete_voter, get_election, post_election, delete_election }